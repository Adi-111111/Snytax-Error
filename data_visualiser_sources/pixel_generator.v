module pixel_generator #(
    ...
    wire [(N_FEATURES*16)-1:0] feature_regs_flat;
    genvar pfi;
    generate
        for (pfi = 0; pfi < N_FEATURES; pfi = pfi + 1) begin : pack_fr
            assign feature_regs_flat[pfi*16 +: 16] = feature_regs[pfi];
        end
    endgenerate
    ...
    // Input builder
    // -----------------------------------------------------------------------
    wire [(N_FEATURES*16)-1:0] input_vec_flat;
    ...
    input_builder #(.N_FEATURES(N_FEATURES)) ib (
        ...
        .feature_regs_flat(feature_regs_flat),
        .x_flat(input_vec_flat)
    );
